...
<div class="section-header">
    <h1>Karyawan</h1>
    <div class="ml-auto">
        <a href="javascript:void(0)" class="btn btn-primary" id="button_tambah_karyawan"><i class="fa fa-plus"></i> Tambah Karyawan</a>
    </div>
</div>
...
<script>
    ...
    $('#update').click(function(e){
        ...
        $.ajax({
            ...
            error:function(error){
                if(error.responseJSON && error.responseJSON.edit_karyawan && error.responseJSON.edit_karyawan[0]){
