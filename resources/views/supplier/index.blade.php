...
<div class="section-header">
    ...
    <div class="ml-auto">
        <a href="javascript:void(0)" class="btn btn-primary" id="button_tambah_supplier"><i class="fa fa-plus"></i> Tambah Supplier</a>
    </div>
</div>
        ...
        success: function(response){
            ...
            $.each(response.data, function(key, value){
                ...
                <tr class="barang-row" id="index_${value.id}">
                    ...
                    <td>${value.alamat}</td>
                    <td>
                        <a href="javascript:void(0)" id="button_edit_supplier" data-id="${value.id}" class="btn btn-lg btn-warning mb-2"><i class="far fa-edit"></i> </a>
                        <a href="javascript:void(0)" id="button_hapus_supplier" data-id="${value.id}" class="btn btn-lg btn-danger mb-2"><i class="fas fa-trash"></i> </a>
                    </td>
                </tr>
            `;
