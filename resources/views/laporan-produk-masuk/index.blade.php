...
@section('content')
    ...
    <div class="section-header">
        ...
        <div class="ml-auto">
            <a href="javascript:void(0)" class="btn btn-danger" id="print-laporan-produk-masuk"><i
                    ...
                    success: function(response) {
                        ...
                        if (response.length === 0) {
                            ...
                            $.each(response, function(key, value) {
                                let formattedHargaBeli = parseFloat(value.harga_beli)
                                    .toLocaleString('id-ID', {
                                        style: 'currency',
                                        currency: 'IDR'
                                    });
                                let formattedTotalHarga = parseFloat(value.total_harga)
                                    .toLocaleString('id-ID', {
                                        style: 'currency',
                                        currency: 'IDR'
                                    });
